...
def get_args():
    ...
    parser.add_argument("--num_epochs", default=6000, type=int, help="Number of epochs for training")
    ...
    parser.add_argument("--weights_path", default='/home/fmr/workspace/scalpel/savedweights/focallosssimplered/model_weights_epoch_4000.pt', type=str, help="Path to weights for initializing model")
...
def main(args):
    ...
    # Model setup
    model = SimpleObjectDetectorRedInput(input_size=args.input_size)
